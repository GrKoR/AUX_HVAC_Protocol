...
Для новых систем (возможно, для инверторных) могут быть варианты:  
...
**НУЖНО ПРОВЕРИТЬ!** Если ограничение установлено, кондиционер не будет работать на мощности выше заданной. Ниже может, выше - нет.  
