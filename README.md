...
- `0xE4` (1110 0100) - инверторный сплит, вероятно значение для пакета дежурного информирования. Встречается в логах с периодом порядка 10 минут.

То есть `1` в 5 бите означает, что сплит инверторный.
