...
> **Из сообщества (Brokly):** Это (биты 0-5) счетчик минут с момента последней команды с пульта.
> То есть каждое новое нажатие обнуляет счетчик. Думаю что в пакете с командой от свистка так же нужно его обнулять.

Я посмотрел по логам. Официальный донгл кондиционера не обнуляет этот счетчик.

> **Проверить!** Надо проверить, как ведет себя этот счетчик при переполнении 6 бит.
